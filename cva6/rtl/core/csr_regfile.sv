...
#(
    ...
    // VS timer interrupt line - ID_STAGE
    output logic vs_timer_irq_o,
    // VS external interrupt line - ID_STAGE
    output logic vs_ext_irq_o,
    ...
    output logic hu_o,
    // AIA top interrupt - ID STAGE
    input logic [CVA6Cfg.XLEN-1:0] mtopi_i,
    input logic [CVA6Cfg.XLEN-1:0] stopi_i,
    input logic [CVA6Cfg.XLEN-1:0] vstopi_i,
  ...
  logic [31:0] rimsic_addr, wimsic_addr;
  logic [CVA6Cfg.NrVSIntpFilesW:0] rimsic_vgein, wimsic_vgein;
  logic [CVA6Cfg.XLEN-1:0] hgeip;
  ...
  if (CVA6Cfg.RVCSRIND) begin
    assign ind_csr_addr = riscv::convert_csrind_access(vs_csr_addr, 
                                  miselect_q, siselect_q, vsiselect_q);
    assign raw_indcsr_addr = riscv::csr_ind_reg_t'(ind_csr_addr.csr_addr);
  end
  else begin
    assign ind_csr_addr = riscv::csr_ind_t'(vs_csr_addr);
    assign raw_indcsr_addr = riscv::csr_ind_reg_t'('0);
  end

  assign conv_csr_addr = ind_csr_addr.csr_addr.csr;

  assign fs_o = mstatus_q.fs;
  assign vfs_o = (CVA6Cfg.RVH) ? vsstatus_q.fs : riscv::Off;
  assign vs_o = mstatus_q.vs;

  assign hgeip = CVA6Cfg.XLEN'({irq_i[CVA6Cfg.NrIntpFiles-1:2], 1'b0});
  ...
  always_comb begin : csr_read_process
    ...
    if (csr_read) begin
      if (!ind_csr_addr.csr_addr.csrind_only) begin   // The CSR belongs to the normal CSR space and may be accessed either via direct or indirect access
        unique case (conv_csr_addr.address)
          ...
          riscv::CSR_VSIEH:
          if (CVA6Cfg.RVH && CVA6Cfg.XLEN == 32)
            csr_rdata = '0;
          else read_access_exception = 1'b1;
          riscv::CSR_VSIP:
          if (CVA6Cfg.RVH)
          ...
          riscv::CSR_VSTIMECMP:
          if (CVA6Cfg.RVH && CVA6Cfg.RVSSTC) csr_rdata = vstimecmp_q[CVA6Cfg.XLEN-1:0];
          else read_access_exception = 1'b1;
          riscv::CSR_VSTIMECMPH:
          if (CVA6Cfg.RVH && CVA6Cfg.RVSSTC && CVA6Cfg.XLEN == 32) csr_rdata = vstimecmp_q[63:32];
          else read_access_exception = 1'b1;
          riscv::CSR_VSISELECT:
          ...
          riscv::CSR_VSTOPEI: begin
            if(CVA6Cfg.RVH) begin
              automatic int vgein = hstatus_q.vgein[CVA6Cfg.NrVSIntpFilesW:0];
              csr_rdata = ((imsic_csr_i.xtopei[imsic_pkg::S_FILE + vgein] << 16) | 
                                      imsic_csr_i.xtopei[imsic_pkg::S_FILE + vgein]);
            end
            else read_access_exception = 1'b1;
          end
          riscv::CSR_VSTOPI: begin
            if(CVA6Cfg.RVH) begin
                csr_rdata = (vstopi_i == 0) ? '0 : (((vstopi_i-1) << 16) | CVA6Cfg.XLEN'(1'b1));
            end
            else read_access_exception = 1'b1;
          end
          riscv::CSR_VSATP:
          ...
          riscv::CSR_SIEH:
          if (CVA6Cfg.RVS && CVA6Cfg.XLEN == 32)
            csr_rdata = '0;
          else read_access_exception = 1'b1;
          riscv::CSR_SIP:
          if (CVA6Cfg.RVS)
          ...
          riscv::CSR_STIMECMP:
          if (CVA6Cfg.RVS && CVA6Cfg.RVSSTC) csr_rdata = stimecmp_q[CVA6Cfg.XLEN-1:0];
          else read_access_exception = 1'b1;
          riscv::CSR_STIMECMPH:
          if (CVA6Cfg.RVS && CVA6Cfg.RVSSTC && CVA6Cfg.XLEN == 32) csr_rdata = stimecmp_q[63:32];
          else read_access_exception = 1'b1;
          riscv::CSR_SISELECT:
          ...
          riscv::CSR_STOPEI:
          if (CVA6Cfg.RVS) csr_rdata = ((imsic_csr_i.xtopei[imsic_pkg::S_FILE] << 16) |
                                                  (imsic_csr_i.xtopei[imsic_pkg::S_FILE]));
          else read_access_exception = 1'b1;
          riscv::CSR_STOPI:
          if (CVA6Cfg.RVS) csr_rdata = (stopi_i == 0) ? '0 : ((stopi_i << 16) | CVA6Cfg.XLEN'(1'b1));
          else read_access_exception = 1'b1;
          ...
          riscv::CSR_HTIMEDELTAH:
          if (CVA6Cfg.RVH && CVA6Cfg.XLEN == 32) csr_rdata = htimedelta_q[63:32];
          else read_access_exception = 1'b1;
          riscv::CSR_HGEIE:
          if (CVA6Cfg.RVH) csr_rdata = hgeie_q;
          else read_access_exception = 1'b1;
          riscv::CSR_HGEIP:
          if (CVA6Cfg.RVH) csr_rdata = hgeip;
          else read_access_exception = 1'b1;
          riscv::CSR_HENVCFG:
          if (CVA6Cfg.RVH) begin
            if (CVA6Cfg.XLEN == 64) csr_rdata = {{hstce_q & mstce_q, {CVA6Cfg.XLEN - 2{1'b0}}}, fiom_q};
            else csr_rdata = {{CVA6Cfg.XLEN - 1{1'b0}}, fiom_q};
          end
          else read_access_exception = 1'b1;
          riscv::CSR_HENVCFGH:
          if (CVA6Cfg.RVH && CVA6Cfg.XLEN == 32) csr_rdata = {hstce_q & mstce_q, {CVA6Cfg.XLEN - 1{1'b0}}};
          else read_access_exception = 1'b1;
          ...
          riscv::CSR_MIDELEGH:
          if (CVA6Cfg.XLEN == 32 && CVA6Cfg.RVS) csr_rdata = '0;
          else read_access_exception = 1'b1;
          ...
          riscv::CSR_MENVCFG:
          if (CVA6Cfg.XLEN == 64) csr_rdata = {{mstce_q, {CVA6Cfg.XLEN - 2{1'b0}}}, fiom_q};
          else csr_rdata = {{CVA6Cfg.XLEN - 1{1'b0}}, fiom_q};
          riscv::CSR_MENVCFGH:
          if (CVA6Cfg.XLEN == 32) csr_rdata = {mstce_q, {CVA6Cfg.XLEN - 1{1'b0}}};
          else read_access_exception = 1'b1;
          riscv::CSR_MISELECT:
          ...
          riscv::CSR_MTOPEI: 
          csr_rdata = ((imsic_csr_i.xtopei[imsic_pkg::M_FILE] << 16) |
                                    (imsic_csr_i.xtopei[imsic_pkg::M_FILE]));
          riscv::CSR_MTOPI:
          csr_rdata = (mtopi_i == 0) ? '0 : ((mtopi_i << 16) | CVA6Cfg.XLEN'(1'b1));
          ...
          riscv::CSR_TIME:
          if (CVA6Cfg.RVZicntr) csr_rdata = timer_i[CVA6Cfg.XLEN-1:0];
          else read_access_exception = 1'b1;
          riscv::CSR_TIMEH:
          if (CVA6Cfg.RVZicntr && CVA6Cfg.XLEN == 32) csr_rdata = timer_i[63:32];
          else read_access_exception = 1'b1;
          riscv::CSR_INSTRET:
        ...
        if (CVA6Cfg.RVCSRIND) begin
          unique case (raw_indcsr_addr)
            // M-mode iprio
            riscv::CSR_MIPRIO: begin
              if (!ind_csr_addr.xiselect[0] || (CVA6Cfg.XLEN == 32)) begin
                csr_rdata = '0;
              end
              else read_access_exception = 1'b1;
            end
            // M-mode IMSIC IF
            riscv::CSR_MIMSIC: begin
              if (!ind_csr_addr.xiselect[0] || (CVA6Cfg.XLEN == 32) || (ind_csr_addr.xiselect < 'h80)) begin
                rimsic_addr = ind_csr_addr.xiselect[31:0]; 
            ...
            // Guest IMSIC IFs
            riscv::CSR_VSIMSIC: begin
              if (!ind_csr_addr.xiselect[0] || (CVA6Cfg.XLEN == 32) || (ind_csr_addr.xiselect < 'h80)) begin
                rimsic_addr = ind_csr_addr.xiselect[31:0]; 
                rimsic_priv_lvl = riscv::PRIV_LVL_S;
                rimsic_vgein = hstatus_q.vgein[CVA6Cfg.NrVSIntpFilesW:0];
                csr_rdata = imsic_csr_i.imsic_data;
              end
              else virtual_read_access_exception = 1'b1;
            end
            // spmpcfg
  ...
  always_comb begin : csr_update
    ...
    if (csr_we) begin
      if (!ind_csr_addr.csr_addr.csrind_only) begin   // The CSR belongs to the normal CSR space and may be accessed either via direct or indirect access
        unique case (conv_csr_addr.address)
          ...
          riscv::CSR_VSTIMECMP:
          if (CVA6Cfg.RVH && CVA6Cfg.RVSSTC) vstimecmp_d[CVA6Cfg.XLEN-1:0] = csr_wdata;
          else update_access_exception = 1'b1;
          riscv::CSR_VSTIMECMPH:
          if (CVA6Cfg.RVH && CVA6Cfg.RVSSTC && CVA6Cfg.XLEN == 32) vstimecmp_d[63:32] = csr_wdata;
          else update_access_exception = 1'b1;
          riscv::CSR_VSISELECT:
          ...
          riscv::CSR_VSTOPEI: begin
            if(CVA6Cfg.RVH) begin
              ...
              wimsic_vgein = hstatus_q.vgein[CVA6Cfg.NrVSIntpFilesW:0];
          ...
          riscv::CSR_SIEH:
          if (!CVA6Cfg.RVS || CVA6Cfg.XLEN != 32) update_access_exception = 1'b1;
          riscv::CSR_SIP: begin
            if (CVA6Cfg.RVS) begin
          ...
          riscv::CSR_STIMECMP:
          if (CVA6Cfg.RVS && CVA6Cfg.RVSSTC) stimecmp_d[CVA6Cfg.XLEN-1:0] = csr_wdata;
          else update_access_exception = 1'b1;
          riscv::CSR_STIMECMPH:
          if (CVA6Cfg.RVS && CVA6Cfg.RVSSTC && CVA6Cfg.XLEN == 32) stimecmp_d[63:32] = csr_wdata;
          else update_access_exception = 1'b1;
          riscv::CSR_SISELECT:
          ...
          riscv::CSR_HVIEN: begin
            if (!CVA6Cfg.RVH) update_access_exception = 1'b1;
          end
          riscv::CSR_HVIENH: begin
            if (!CVA6Cfg.RVH || CVA6Cfg.XLEN != 32) update_access_exception = 1'b1;
          end
          ...
          riscv::CSR_HVIPRIO1H: begin
            if (!CVA6Cfg.RVH && CVA6Cfg.XLEN != 32) update_access_exception = 1'b1;
          end
          riscv::CSR_HVIPRIO2: begin
            if (!CVA6Cfg.RVH) update_access_exception = 1'b1;
          end
          riscv::CSR_HVIPRIO2H: begin
            if (!CVA6Cfg.RVH && CVA6Cfg.XLEN != 32) update_access_exception = 1'b1;
          end
          ...
          riscv::CSR_HTIMEDELTAH:
          if (CVA6Cfg.RVH && CVA6Cfg.XLEN == 32) htimedelta_d[63:32] = csr_wdata;
          else update_access_exception = 1'b1;
          ...
          riscv::CSR_HGEIE: begin
            if (CVA6Cfg.RVH) begin
              hgeie_d = CVA6Cfg.XLEN'({csr_wdata[CVA6Cfg.NrVSIntpFiles:1], 1'b0});
            end
            else update_access_exception = 1'b1;
          end
          riscv::CSR_HGATP: begin
          ...
          if (CVA6Cfg.RVH) begin
            fiom_d = csr_wdata[0];
            if (CVA6Cfg.RVSSTC && CVA6Cfg.XLEN == 64) hstce_d = csr_wdata[63] & mstce_q;
          end
          else update_access_exception = 1'b1;
          riscv::CSR_HENVCFGH:
          if (CVA6Cfg.RVH && CVA6Cfg.XLEN == 32) begin
            if (CVA6Cfg.RVSSTC) hstce_d = csr_wdata[31] & mstce_q;
          end
          else update_access_exception = 1'b1;
          ...
          riscv::CSR_MIEH: if (CVA6Cfg.XLEN != 32) update_access_exception = 1'b1;
          ...
          riscv::CSR_MVIEN: if (!CVA6Cfg.RVS) update_access_exception = 1'b1;
          riscv::CSR_MVIENH: if (!CVA6Cfg.RVS || CVA6Cfg.XLEN != 32) update_access_exception = 1'b1;
          riscv::CSR_MVIP: if (!CVA6Cfg.RVS) update_access_exception = 1'b1;
          riscv::CSR_MVIPH: if (!CVA6Cfg.RVS || CVA6Cfg.XLEN != 32) update_access_exception = 1'b1;
          ...
          riscv::CSR_MIPH: if (CVA6Cfg.XLEN != 32) update_access_exception = 1'b1;
          ...
          riscv::CSR_MENVCFGH:
          if (CVA6Cfg.XLEN == 32) begin
            if (CVA6Cfg.RVSSTC) mstce_d = csr_wdata[31];
          end
          else update_access_exception = 1'b1;
          riscv::CSR_MISELECT:
        ...
        unique case (raw_indcsr_addr)
          // M-mode iprio
            ...
            riscv::CSR_MIMSIC: begin
              if (!ind_csr_addr.xiselect[0] || (CVA6Cfg.XLEN == 32) || (ind_csr_addr.xiselect < 'h80)) begin
                wimsic_addr = ind_csr_addr.xiselect[31:0]; 
                wimsic_priv_lvl = riscv::PRIV_LVL_M;
                wimsic_vgein = '0;
          ...
          riscv::CSR_VSIMSIC: begin
            if (!ind_csr_addr.xiselect[0] || (CVA6Cfg.XLEN == 32) || (ind_csr_addr.xiselect < 'h80)) begin
              ...
              else virtual_update_access_exception = 1'b1;
          end
          // spmpcfg
          riscv::CSR_SPMPCFG: begin
            if (CVA6Cfg.RVS && CVA6Cfg.NrSPMPEntries != 0) begin
          ...
          riscv::CSR_VSPMPCFG: begin
            if (CVA6Cfg.RVH && CVA6Cfg.NrVSPMPEntries != 0) begin
              automatic int pmp_idx = (int'(ind_csr_addr.xiselect) - riscv::XISELECT_SPMP_BASE) 
                                        + CVA6Cfg.NrPMPEntries + CVA6Cfg.NrSPMPEntries;
              automatic int vspmp_idx = int'(ind_csr_addr.xiselect) - riscv::XISELECT_SPMP_BASE;
              // Only M-mode or accesses via miselect/siselect or HS-mode accesses via siselect can unlock/modify locked vSPMP CSRs
    ...
    // VS-mode timer and external interrupts
    if (CVA6Cfg.RVH) begin
      vs_ext_irq_o = hgeip[hstatus_q.vgein];
      if (CVA6Cfg.RVSSTC) begin
        vs_timer_irq_o = (mstce_q && hstce_q) ? 
                          (((timer_i + htimedelta_q) >= vstimecmp_q) && (vstimecmp_q != '0)) :
                          1'b0;
      end
      else vs_timer_irq_o = 1'b0;
    end
    else begin
      vs_timer_irq_o = 1'b0;
      vs_ext_irq_o = 1'b0;
  ...
  always_comb begin : privilege_check
    if (CVA6Cfg.RVH) begin
      ...
      if (csr_op_i inside {CSR_WRITE, CSR_SET, CSR_CLEAR, CSR_READ}) begin
        ...
        if (CVA6Cfg.RVZicntr) begin
          if (csr_addr_i inside {[riscv::CSR_CYCLE : riscv::CSR_INSTRET]} |
            ...
            if (curr_priv == riscv::PRIV_LVL_S && CVA6Cfg.RVS) begin
              ...
              virtual_privilege_violation = v_q & mcounteren_q[sel_cnt_en] & (~hcounteren_q[sel_cnt_en] | ~scounteren_q[sel_cnt_en]);
              privilege_violation = ~mcounteren_q[sel_cnt_en] | (~v_q & ~scounteren_q[sel_cnt_en]);
            end else if (priv_lvl_o == riscv::PRIV_LVL_M) begin
              privilege_violation = 1'b0;
            end
          end
        ...
        if (CVA6Cfg.RVSSTC) begin
          if (csr_addr_i inside {riscv::CSR_VSTIMECMP, riscv::CSR_VSTIMECMPH, 
                                 riscv::CSR_STIMECMP, riscv::CSR_STIMECMPH}) begin
            if (curr_priv == riscv::PRIV_LVL_S && CVA6Cfg.RVS) begin
              virtual_privilege_violation = v_q & ((mstce_q & ~hstce_q) | (mcounteren_q[1] & ~hcounteren_q[1]));
              privilege_violation = ~mstce_q | ~mcounteren_q[1];
            end
          end
        end
      end
      ...
      if (csr_op_i inside {CSR_WRITE, CSR_SET, CSR_CLEAR, CSR_READ}) begin
        ...
        if (CVA6Cfg.RVSSTC) begin
          if (csr_addr_i inside {riscv::CSR_STIMECMP, riscv::CSR_STIMECMPH}) begin
            if (priv_lvl_o == riscv::PRIV_LVL_S && CVA6Cfg.RVS) begin
              privilege_violation = ~mstce_q | ~mcounteren_q[1];
            end
          end
  ...
  always_comb begin : wfi_ctrl
    ...
    if (|(mip_q & mie_q) || (CVA6Cfg.DebugEn && debug_req_i) || (mie_q[riscv::IRQ_S_EXT] & irq_i[1]) ||
          (mie_q[riscv::IRQ_VS_TIMER] && vs_timer_irq_o) || (mie_q[riscv::IRQ_VS_EXT] && vs_ext_irq_o)) begin
      wfi_d = 1'b0;
  ...
  always_comb begin
    ...
    // bit and the interrupt signal from the interrupt controller or timer comparison.
    ...
    if (CVA6Cfg.RVH) begin
      unique case (conv_csr_addr.address)
        riscv::CSR_MIP: begin
          if (CVA6Cfg.RVSSTC)
            csr_rdata_o = csr_rdata | (CVA6Cfg.XLEN'(irq_i[1]) << riscv::IRQ_S_EXT) | 
                                      (CVA6Cfg.XLEN'(vs_timer_irq_o) << riscv::IRQ_VS_TIMER) | 
                                      (CVA6Cfg.XLEN'(vs_ext_irq_o) << riscv::IRQ_VS_EXT);
          else
            csr_rdata_o = csr_rdata | (CVA6Cfg.XLEN'(irq_i[1]) << riscv::IRQ_S_EXT) | 
                                      (CVA6Cfg.XLEN'(vs_ext_irq_o) << riscv::IRQ_VS_EXT);
        end
        // in less privileged modes we need to check whether the interrupt is delegated
        riscv::CSR_SIP: begin
          csr_rdata_o = csr_rdata | (CVA6Cfg.XLEN'(irq_i[1] & mideleg_q[riscv::IRQ_S_EXT]) << riscv::IRQ_S_EXT);
        end
        riscv::CSR_HIP: begin
          if (CVA6Cfg.RVSSTC)
            csr_rdata_o = csr_rdata | (CVA6Cfg.XLEN'(vs_timer_irq_o) << riscv::IRQ_VS_TIMER) |
                                      (CVA6Cfg.XLEN'(vs_ext_irq_o) << riscv::IRQ_VS_EXT);
          else
            csr_rdata_o = csr_rdata | (CVA6Cfg.XLEN'(vs_ext_irq_o) << riscv::IRQ_VS_EXT);
        end
        riscv::CSR_VSIP: begin
          if (CVA6Cfg.RVSSTC)
            csr_rdata_o = csr_rdata | (CVA6Cfg.XLEN'(vs_timer_irq_o & hideleg_q[riscv::IRQ_VS_TIMER]) << riscv::IRQ_VS_TIMER) |
                                      (CVA6Cfg.XLEN'(vs_ext_irq_o & hideleg_q[riscv::IRQ_VS_EXT]) << riscv::IRQ_VS_EXT);
          else
            csr_rdata_o = csr_rdata | (CVA6Cfg.XLEN'(vs_ext_irq_o & hideleg_q[riscv::IRQ_VS_EXT]) << riscv::IRQ_VS_EXT);
        end
        default:;
      endcase
    end
  ...
  assign imsic_csr_o.imsic_addr = (imsic_csr_o.imsic_we || imsic_csr_o.imsic_claim) ? wimsic_addr : rimsic_addr;
  assign imsic_csr_o.priv_lvl = (imsic_csr_o.imsic_we || imsic_csr_o.imsic_claim) ? wimsic_priv_lvl : rimsic_priv_lvl;
  assign imsic_csr_o.vgein = (imsic_csr_o.imsic_we || imsic_csr_o.imsic_claim) ? wimsic_vgein : rimsic_vgein;
  ...
  always_ff @(posedge clk_i or negedge rst_ni) begin
    if (~rst_ni) begin
      ...
      if (CVA6Cfg.RVH) begin
        ...
        vstval_q                 <= vstval_d;
        if (CVA6Cfg.RVSSTC) vstimecmp_q <= vstimecmp_d;
