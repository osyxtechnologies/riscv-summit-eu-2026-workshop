...
Unless otherwise stated, files are licensed under the **Apache License,
...
are proprietary to **OSYX Technologies, Lda.** and are **not** licensed
under the Apache License 2.0. See
[`LICENSE-OSYX-PROPRIETARY`](LICENSE-OSYX-PROPRIETARY) for the applicable
terms. SPDX-standard copies of both licenses are available under the
