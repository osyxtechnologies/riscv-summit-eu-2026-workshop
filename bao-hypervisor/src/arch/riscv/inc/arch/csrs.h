...
#define CSR_HSPMPEN       0x683
#define CSR_HSPMPPENH     0x693
#define CSR_HSPMPDELEG    0x616
#define CSR_VSPMPEN       0x283
#define CSR_VSPMPPENH     0x293
...
#define HSPMPDELEG_PMPNUM_OFF   (0)
#define HSPMPDELEG_PMPNUM_LEN   (8)
#define HSPMPDELEG_PMPNUM_MSK   BIT_MASK(HSPMPDELEG_PMPNUM_OFF, HSPMPDELEG_PMPNUM_LEN)
...
#define HSTATEEN0_IMSIC             (1ULL << 58)
#define HSTATEEN0_AIA               (1ULL << 59)
...
CSRS_GEN_ACCESSORS_NAMED(hgeie, CSR_HGEIE)
CSRS_GEN_ACCESSORS_NAMED(hcounteren, CSR_HCOUNTEREN)
CSRS_GEN_ACCESSORS_NAMED(scounteren, CSR_SCOUNTEREN)
CSRS_GEN_ACCESSORS_NAMED(senvcfg, CSR_SENVCFG)
...
CSRS_GEN_ACCESSORS_NAMED(siselect, CSR_SISELECT)
CSRS_GEN_ACCESSORS_NAMED(sireg, CSR_SIREG)
CSRS_GEN_ACCESSORS_NAMED(sireg2, CSR_SIREG2)
CSRS_GEN_ACCESSORS_NAMED(vsiselect, CSR_VSISELECT)
CSRS_GEN_ACCESSORS_NAMED(vsireg, CSR_VSIREG)
CSRS_GEN_ACCESSORS_NAMED(vsireg2, CSR_VSIREG2)
CSRS_GEN_ACCESSORS_NAMED(stopei, CSR_STOPEI)
CSRS_GEN_ACCESSORS_NAMED(stopi, CSR_STOPI)
CSRS_GEN_ACCESSORS_NAMED(hspmpdeleg, CSR_HSPMPDELEG)
#if defined(RV64)
...
CSRS_GEN_ACCESSORS_NAMED(spmpen, CSR_SPMPEN)
CSRS_GEN_ACCESSORS_NAMED(hspmpen, CSR_HSPMPEN)
CSRS_GEN_ACCESSORS_NAMED(vspmpen, CSR_VSPMPEN)
#else
CSRS_GEN_ACCESSORS_NAMED(timel, time)
CSRS_GEN_ACCESSORS_NAMED(timeh, timeh)
...
CSRS_GEN_ACCESSORS_NAMED(spmpenl, CSR_SPMPEN)
CSRS_GEN_ACCESSORS_NAMED(spmpenh, CSR_SPMPENH)
CSRS_GEN_ACCESSORS_MERGED(spmpen, spmpenl, spmpenh)

CSRS_GEN_ACCESSORS_NAMED(hspmppenl, CSR_HSPMPEN)
CSRS_GEN_ACCESSORS_NAMED(hspmppenh, CSR_HSPMPPENH)
CSRS_GEN_ACCESSORS_MERGED(hspmpen, hspmppenl, hspmppenh)

CSRS_GEN_ACCESSORS_NAMED(vspmppenl, CSR_VSPMPEN)
CSRS_GEN_ACCESSORS_NAMED(vspmppenh, CSR_VSPMPPENH)
CSRS_GEN_ACCESSORS_MERGED(vspmpen, vspmppenl, vspmppenh)
#endif
